...
(function () {
    ...
    if (arr) {
      ...
      if (gameInterface === "ni")
        src =
          ...
          version +
          "/dist/chat-plus-plus-NI.js";
      else if (gameInterface === "si")
        src =
          "https://cdn.jsdelivr.net/gh/KrisAphalon/margonem-chat-plus-plus@" +
          version +
          "/dist/chat-plus-plus-SI.js";
      else {
  ...
  request.open(
    "GET",
    "https://raw.githubusercontent.com/KrisAphalon/margonem-chat-plus-plus/production/version",
    true,
  );
  request.onload = function () {
    if (this.status >= 200 && this.status < 400)
      start(this.response.toString());
    else
      console.error(
        "Chat Plus Plus version check returned error: " + this.status,
      );
  };
